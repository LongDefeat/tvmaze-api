...
async function searchShows(query) {
  ...
  if (!query) {
    return console.error("query is required for searchShows()");
  }
      ...
      `<div class="col-md-6 col-lg-3 Show" data-show-id="${show.id}">
               <div class="card" data-show-id="${show.id}">
                 <div class="card-body">
                   ...
                   <img class="card-text" src="${show.image}">
                   <button class="display-episodes" data-show-id="${show.id}">Show Episodes</button>
                 </div>
               </div>
             </div>
            `
...
$(document).on("click", ".display-episodes", async (e) => {
  e.preventDefault();
